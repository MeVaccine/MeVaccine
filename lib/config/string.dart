...
const generalExceptionTH = "มีข้อผิดพลาดเกินขึ้น โปรดลองใหม่อีกครั้ง";
...
const notRegister =
    "National ID and/or phoneNumber is not correct or user have not register yet";
const getUserException =
    "JWT token is not present or querying user that not your person";
